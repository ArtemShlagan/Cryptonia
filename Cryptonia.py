...
logger = logging.getLogger('CryptoniaCopyBot')

api_id = '23415626'
api_hash = '84407a767ffbbd9ce175bb9dba5948f2'

channel_pairs = [
    ('@DnevnikCapitanika', -1002179140648),
    ('@Kripto_Azbuk', -1002179140648),
    ('@cryptogram_web3', -1002179140648),
    ('@TumoBogCrypto', -1002179140648),
]
...
def remove_all_link_lines(message):
    ...
    if removed_any:
        inline_link = '<a href="https://t.me/+voBUqjKOJI83YTdi">CRYPTONIA</a>'
        if new_text:
            new_text += "\n" + inline_link
        else:
